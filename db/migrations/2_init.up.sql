...
(
    ...
    dish_kcal float NOT NULL CHECK (dishes_kcal >= 0),
    dish_proteins float NOT NULL CHECK (dishes_proteins >= 0),
    dish_fats float NOT NULL CHECK (dishes_fats >= 0),
    dish_carbs float NOT NULL CHECK (dishes_carbs >= 0),
...
(
    ...
    dish_weight not null check (dish_weight > 0),
    date text NOT NULL,
);
